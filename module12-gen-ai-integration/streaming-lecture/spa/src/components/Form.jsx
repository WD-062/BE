      ...
      if (isStream) {
        ...
        while (true) {
          ...
          lines.forEach(line => {
            ...
            // check if data has chatId property or text property

            //if it has chatId property - update chatId state and local storage

            // else if data has text property, update messages state

            // when updating messages state
            // check if the message exists
            // if the message exists - add the new text
            // if if doesn't exist, add a new message to the array
          });
        }
        // after the break
      } else {
